<form action="/repairs/search" class="navbar-form navbar-right" id="searchFormRepairs" name="searchFormRepairs"
    ...
    <div class="form-group">
        ...
        <input class="form-control" type="text" name="carPlate" id="carPlate" placeholder="carPlate">
        <input class="form-control" type="text" name="dayOfRepair" id="dayOfRepair" placeholder="dayOfRepair">
