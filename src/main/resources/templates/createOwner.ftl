            ...
            <form class="form-horizontal" action="/owners" method="POST" name="ownerForm" id="ownerForm">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="form-group">
                        <@spring.bind "ownerForm.taxRegNum"/>
                            <label for="productCode">Tax Registration Number</label>
                            <input type="text" class="form-control" name="taxRegNum" id="taxRegNum" placeholder="Enter a valid Tax Number"/>
                    ...
                    <div class="form-group">
                        <@spring.bind "ownerForm.userFirstName"/>
                    ...
                    <div class="form-group">
                        <@spring.bind "ownerForm.userLastName"/>
